...
export function FeaturesSectionDemo() {
  ...
  return (
    <section>
      <h4 className="text-center mt-24">Başlıca Hizmetlerimiz</h4>
...
const Feature = ({
  ...
  `}
    >
      {index < 4 && (
        <div className="opacity-0 group-hover/feature:opacity-100 transition duration-200 absolute inset-0 h-full w-full " />
      )}
      {index >= 4 && (
        <div className="opacity-0 group-hover/feature:opacity-100 transition duration-200 absolute inset-0 h-full w-full" />
      )}
      ...
      <div className="text-lg font-bold mb-2 relative z-10 px-10">
        <div className="absolute left-0 inset-y-0 h-6 group-hover/feature:h-8 w-1 rounded-tr-full rounded-br-full text-primary group-hover/feature:bg-hover transition-all duration-200 origin-center" />
